...
def parse_args():
    ...
    parser.add_argument("--dataset", help="cityscapes_unlabeled_car_only", default=None, type=str)
    parser.add_argument("--outdir", help="output dir for json files", default=None, type=str)
    parser.add_argument("--datadir", help="data dir for annotations to be converted", default=None, type=str)
